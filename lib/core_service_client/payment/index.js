...
module.exports = (client) => ({
    ...
    /**
    * @param {CorePaymentInfoCreateRequest} request
    * @returns {Promise<CorePaymentInfoCreateResponse>}
    */
    ...
    /**
    * @param {CorePaymentInfoGetByPolicyIdRequest} request
    * @returns {Promise<CorePaymentInfoGetByPolicyIdResponse>}
    */
    ...
    /**
    * @param {CorePaymentInfoGetRequest} request
    * @returns {Promise<CorePaymentInfoGetResponse>}
    */
    ...
    /**
    * @param {CorePaymentInfoStateChangeRequest} request
    * @returns {Promise<CorePaymentInfoStateChangeResponse>}
    */
    ...
    /**
    * @param {CorePaymentPaymentCallbackRequest} request
    * @returns {Promise<CorePaymentPaymentCallbackResponse>}
    */
    ...
    /**
    * @param {CorePaymentWithholdingInfoGetRequest} request
    * @returns {Promise<CorePaymentWithholdingInfoGetResponse>}
    */
    ...
    /**
    * @param {CorePaymentWithholdingInfoSetRequest} request
    * @returns {Promise<CorePaymentWithholdingInfoSetResponse>}
    */
    ...
    /**
    * @param {CorePaymentWithholdingSubmitRequest} request
    * @returns {Promise<CorePaymentWithholdingSubmitResponse>}
    */
