...
module.exports = (client) => ({
    ...
    /**
    * @param {CoreAccountCreateRequest} request
    * @returns {Promise<CoreAccountCreateResponse>}
    */
    create: function (request = null, timeout = 30) {
        return client.call('create', request, timeout);
    },
