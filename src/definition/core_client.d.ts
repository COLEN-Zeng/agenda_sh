declare class CoreClientClass {
    static getInstance(): CoreClientClass;

    call(method: string, request: any, timeout?: number): any;

    groupPolicyAdd(request: InsideGroupPolicyAddRequest, timeout: number): InsideGroupPolicyAddResponse;

    insuranceConfigGet(request: InsideInsuranceConfigGetRequest, timeout: number): InsideInsuranceConfigGetResponse;

    payOrderCreate(request: InsidePayOrderCreateRequest, timeout: number): InsidePayOrderCreateResponse;

    payOrderStateChange(request: InsidePayOrderStateChangeRequest, timeout: number): InsidePayOrderStateChangeResponse;

    paymentInfoGet(request: InsidePaymentInfoGetRequest, timeout: number): InsidePaymentInfoGetResponse;

    paymentInfoSync(request: InsidePaymentInfoSyncRequest, timeout: number): InsidePaymentInfoSyncResponse;

    refundOrderCreate(request: InsideRefundOrderCreateRequest, timeout: number): InsideRefundOrderCreateResponse;

    refundOrderGet(request: InsideRefundOrderGetRequest, timeout: number): InsideRefundOrderGetResponse;

    refundOrderStateChange(request: InsideRefundOrderStateChangeRequest, timeout: number): InsideRefundOrderStateChangeResponse;

    reservationPolicyAdd(request: InsideReservationPolicyAddRequest, timeout: number): InsideReservationPolicyAddResponse;

    warehouseEntranceSet(request: InsideWarehouseEntranceSetRequest, timeout: number): InsideWarehouseEntranceSetResponse;

}

interface GroupPolicyAddRequest {
    /**
     * 入口id
     */
    entranceId: string;
 ...
 * 保单id
 */
type GroupPolicyAddResponse = string;


/**
 * 险种id
 */
type InsuranceConfigGetRequest = string;

type InsuranceConfigGetResponse = null | {
    [k: string]: any;
};
 ...
 */
interface PayOrderCreateRequest {
    /**
     * 保单id
     */
    policyId?: string;
...
interface PayOrderStateChangeRequest {
    /**
     * 保单id
     */
    policyId: string;
...
type PayOrderStateChangeResponse = null;


interface PaymentInfoGetRequest {
    /**
...
interface PaymentInfoSyncRequest {
    /**
     * 自有的支付单ID
     */
    paymentId: string;
...
type PaymentInfoSyncResponse = null;


/**
 * 创建支付/退款订单的请求参数, 由调用者决定 required 哪些属性
 */
interface RefundOrderCreateRequest {
    /**
     * 保单id
     */
    policyId?: string;
...
type RefundOrderCreateResponse = null | {
    /**
     * 自有的支付单ID
     */
    paymentId: string;
...
interface RefundOrderGetRequest {
    /**
     * 保单id
     */
    policyId: string;
...
type RefundOrderGetResponse = null | {
    /**
     * 支付单ID
     */
    id: string;
...
interface RefundOrderStateChangeRequest {
    /**
     * 保单id
     */
    policyId: string;
...
type RefundOrderStateChangeResponse = null;


interface ReservationPolicyAddRequest {
    /**
     * 入口id
     */
    entranceId: string;
 ...
 * 保单id
 */
type ReservationPolicyAddResponse = string;


interface WarehouseEntranceSetRequest {
    id?: string;
    mode?: string;
    insuranceId?: string;
    insuranceIds?: string[];
...
type WarehouseEntranceSetResponse = null;
